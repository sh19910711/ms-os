...
void _Timer::set_interval(int ms, void (*callback)()) {
    ...
    result_t r;
    call_timer_set_interval(timer_server, transfer_to(app_channel), ms, (uintmax_t) callback, &r);
}
...
void _Timer::set_oneshot(int ms, void (*callback)()) {
    ...
    result_t r;
    call_timer_set_oneshot(timer_server, transfer_to(app_channel), ms, (uintmax_t) callback, &r);
}
